    ...
    <div class="bg-white rounded-lg border border-gray-200 p-4">
        <form method="POST" action="{{ route('dashboard.articles.store') }}" enctype="multipart/form-data">
            ...
            <div class="space-y-4">
                ...
                {{-- Image --}}
                <div>
                    <label class="block text-xs font-medium text-gray-700 mb-1.5">Image <span class="text-red-500">*</span></label>
                ...
                <div class="flex justify-end gap-2 pt-3">
                    ...
                    <button type="submit"
                            class="px-4 py-2 text-sm bg-indigo-600 text-white rounded hover:bg-indigo-700">Create Article</button>
                </div>
