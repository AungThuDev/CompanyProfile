...
<div class="max-w-4xl mx-auto space-y-4">
    ...
    <div class="bg-white rounded-lg border border-gray-200 p-4">
        <h1 class="text-lg font-semibold text-gray-900">Create New Project Type</h1>
        <p class="text-xs text-gray-500 mt-1">Fill in the details to add a new project type</p>
    </div>
    ...
    {{-- Form --}}
    <div class="bg-white rounded-lg border border-gray-200 p-4">
        <form method="POST" action="{{ route('dashboard.project-types.store') }}">
            @csrf
            <div class="space-y-4">
                ...
                <div class="flex justify-end gap-2 pt-3">
                    ...
                    <button type="submit" class="px-4 py-2 text-sm bg-indigo-600 text-white rounded hover:bg-indigo-700">Create Project Type</button>
                </div>
