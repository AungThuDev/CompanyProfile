...
<div class="max-w-4xl mx-auto space-y-4">
    ...
    <div class="bg-white rounded-lg border border-gray-200 p-4">
        <h1 class="text-lg font-semibold text-gray-900">Edit Tag</h1>
        <p class="text-xs text-gray-500 mt-1">Update the tag details</p>
    </div>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name', $tag->name) }}"
                           class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:ring-indigo-500">
                </div>

                <div>
                    <label class="block text-xs font-medium text-gray-700 mb-1.5">Description</label>
                    <textarea name="description" rows="3" class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm">{{ old('description', $tag->description) }}</textarea>
                </div>
