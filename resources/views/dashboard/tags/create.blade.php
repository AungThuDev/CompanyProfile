...
<div class="max-w-4xl mx-auto space-y-4">
    ...
    <div class="bg-white rounded-lg border border-gray-200 p-4">
        <h1 class="text-lg font-semibold text-gray-900">Create New Tag</h1>
        <p class="text-xs text-gray-500 mt-1">Add a new tag to your platform</p>
    </div>
        ...
        <form action="{{ route('dashboard.tags.store') }}" method="POST">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="description" rows="3" class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm">{{ old('description') }}</textarea>
                </div>
