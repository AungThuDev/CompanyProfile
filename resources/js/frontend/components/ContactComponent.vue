<template>
    <section
        id="contact"
        class="py-32 bg-gradient-to-b from-gray-900 to-black relative overflow-hidden"
    >
        <!-- Background grid -->
        <div
                ...
                <div ref="infoRef" class="space-y-8">
                    ...
                    <div>
                        ...
                        <div class="space-y-6">
                            ...
                            >
                                <div
                                    class="p-3 rounded-lg bg-gradient-to-br from-blue-500/20 to-purple-500/20 border border-white/10"
                                >
                                    <component
                                        :is="item.icon"
                        ...
                        <div class="flex gap-4">
                            ...
                            >
                                ...
                                >
                                    <component
                                        :is="social.icon"
                                        class="w-5 h-5 text-gray-400 hover:text-blue-400"
                                    />
                                </a>
                            </div>
                        </div>
                    ...
                    <form @submit.prevent="handleSubmit" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                />
                                <div
                                    class="pointer-events-none absolute top-2 right-2 text-xs flex items-center gap-2 bg-black/30 backdrop-blur-sm px-2 py-0.5 rounded"
                                >
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                ></textarea>
                                <div
                                    class="pointer-events-none absolute bottom-2 right-2 text-xs flex items-center gap-2 bg-black/30 backdrop-blur-sm px-2 py-0.5 rounded"
                                >
                                    <span class="text-gray-400"
                                        >{{
...
const messageRemaining = computed(() =>
    Math.max(0, MESSAGE_MAX - (formData.message || "").length)
);

const SUBJECT_MAX = 255;
const subjectRemaining = computed(() =>
    Math.max(0, SUBJECT_MAX - (formData.subject || "").length)
);
