    ...
    <div class="min-h-screen bg-black">
            ...
            <div class="max-w-7xl mx-auto px-6 py-24">
                ...
                <div>
                    ...
                    <p class="text-gray-400 max-w-2xl">
                        Explore our complete collection of insights, tutorials, and thought leadership on technology and
                        innovation.
                    </p>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-6 py-16">
            ...
            <div class="flex flex-wrap gap-3 mb-12">
                ...
                <!-- Fixed ALL -->
                <button @click="handleCategoryChange('All')" :class="[
                ...
                <!-- Loop categories -->
                <button v-for="category in categories" :key="category.id" @click="handleCategoryChange(category.name)"
                    :class="[
                        'px-6 py-2 rounded-full transition-all duration-300',
            ...
            <!-- Articles Grid -->
            <div v-if="currentArticles.length" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
